...
async def screenshot_handler(client, message):
    ...
    await message.reply_text("<b><i>PROSES SS PAKAI TABLET KINGZ ♛</i></b>")
    ...
    await client.send_photo(message.chat.id, filepath, caption="**__Nih Kingz Gambarnya Sudah Di Screenshot Memakai Tablet.__**")
    os.remove(filepath)
